...
useEffect(()=>{
 const updateCardToShow =()=>{
    ...
    const Previous=()=>{
        setcurrentIndex((prevIndex)=>(prevIndex ===0 ? projectsData.length -1 : prevIndex - 1) %projectsData.length)
    }
  return (
    <motion.div 
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
      ...
      <p className='text-center text-gray-500 mb-8 mx-w-80 mx-auto'>Crafting Spaces, Building Lwgacies-Explore Our Portfolio</p>
      {/* slider buttons */}
      <div className='flex justify-end items-center mb-8'>
        
        <button onClick={Previous} className='p-3 bg-gray-300 rounded mr-2' aria-label='Preious Prject'>
            <img src={assets.left_arrow} alt="Previous" />
        </button>
    
    
        <button onClick={next} className='p-3 bg-gray-300 rounded mr-2' aria-label='Next Prject'>
